...
export default function AddedIngredient(props) {
    ...
    const addOne = (e) => {
        let array = props.data.amount;
        array[props.ingredientName] = e.target.value;
        console.log(array);
        props.setData('amount', array);
    }
    ...
    return (
        <div className="flex justify-between">
            ...
            <div class="relative flex items-center max-w-[8rem]">
                ...
                <input type="text" id="quantity-input" data-input-counter aria-describedby="helper-text-explanation" class="bg-gray-50 border-x-0 border-gray-300 h-11 text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full py-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-[50px]" placeholder="999" required defaultValue="1" onChange={addOne} />
