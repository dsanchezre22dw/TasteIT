...
export function Configurator() {
  ...
  React.useEffect(() => {
    const stars = fetch(
      "https://api.github.com/repos/dsanchezre22dw/TasteIT"
    )
    ...
    >
      ...
      <div className="py-4 px-6">
        ...
        <div className="mb-12">
          ...
          <hr />
          <a
            className="mx-auto flex items-center justify-center gap-2 mt-3"
            href="https://github.com/dsanchezre22dw/TasteIT"
            target="_blank"
            rel="noreferrer"
          >
            <Chip
